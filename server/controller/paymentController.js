...
export const buySubscription = async (req, res, next) => {
    try {
        ...
        user.subscription.id = "dummy_subscription_id";
...
export const cancelSubscription = async (req, res, next) => {
    try {
        ...
        // Remove any dummy payments if necessary
        await Payment.deleteMany({ subscription_id: subscriptionId });
...
// Removed getRazorpayKey – no longer needed
